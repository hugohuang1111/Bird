...
int lua_PluginAdMobLua_PluginAdMob_setGDPR(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        bool arg0;
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "sdkbox.PluginAdMob:setGDPR");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginAdMobLua_PluginAdMob_setGDPR'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginAdMob:setGDPR",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginAdMobLua_PluginAdMob_setGDPR'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_PluginAdMobLua_PluginAdMob(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginAdMob");
        ...
        tolua_function(tolua_S,"setGDPR", lua_PluginAdMobLua_PluginAdMob_setGDPR);
