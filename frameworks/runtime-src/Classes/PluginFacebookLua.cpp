...
int lua_PluginFacebookLua_PluginFacebook_setLoginBehavior(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        int arg0;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "sdkbox.PluginFacebook:setLoginBehavior");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginFacebookLua_PluginFacebook_setLoginBehavior'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginFacebook:setLoginBehavior",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginFacebookLua_PluginFacebook_setLoginBehavior'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_PluginFacebookLua_PluginFacebook(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginFacebook");
        ...
        tolua_function(tolua_S,"setLoginBehavior", lua_PluginFacebookLua_PluginFacebook_setLoginBehavior);
