...
int lua_PluginSdkboxPlayLua_PluginSdkboxPlay_fetchGameDataNames(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginSdkboxPlayLua_PluginSdkboxPlay_fetchGameDataNames'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginSdkboxPlay:fetchGameDataNames",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginSdkboxPlayLua_PluginSdkboxPlay_fetchGameDataNames'.",&tolua_err);
#endif
    return 0;
}
...
int lua_PluginSdkboxPlayLua_PluginSdkboxPlay_loadOneGameData(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sdkbox.PluginSdkboxPlay:loadOneGameData");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginSdkboxPlayLua_PluginSdkboxPlay_loadOneGameData'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginSdkboxPlay:loadOneGameData",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginSdkboxPlayLua_PluginSdkboxPlay_loadOneGameData'.",&tolua_err);
#endif
    return 0;
}
...
int lua_PluginSdkboxPlayLua_PluginSdkboxPlay_signin(lua_State* tolua_S)
{
    ...
    {
        bool arg0;
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "sdkbox.PluginSdkboxPlay:signin");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginSdkboxPlayLua_PluginSdkboxPlay_signin'", nullptr);
            return 0;
...
int lua_register_PluginSdkboxPlayLua_PluginSdkboxPlay(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginSdkboxPlay");
        ...
        tolua_function(tolua_S,"fetchGameDataNames", lua_PluginSdkboxPlayLua_PluginSdkboxPlay_fetchGameDataNames);
        ...
        tolua_function(tolua_S,"loadOneGameData", lua_PluginSdkboxPlayLua_PluginSdkboxPlay_loadOneGameData);
