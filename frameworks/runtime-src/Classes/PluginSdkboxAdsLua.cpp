...
int lua_PluginSdkboxAdsLua_PluginSdkboxAds_cache(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        std::string arg0;
        std::string arg1;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sdkbox.PluginSdkboxAds:cache");
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sdkbox.PluginSdkboxAds:cache");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginSdkboxAdsLua_PluginSdkboxAds_cache'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginSdkboxAds:cache",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginSdkboxAdsLua_PluginSdkboxAds_cache'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_PluginSdkboxAdsLua_PluginSdkboxAds(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginSdkboxAds");
        ...
        tolua_function(tolua_S,"cache", lua_PluginSdkboxAdsLua_PluginSdkboxAds_cache);
